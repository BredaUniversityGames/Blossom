...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        // - You can use ShowMetricsWindow() to operator() the draw data that are being passed to your renderer,
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Borders, background"))
    {
        ...
        {
            // Display headers so we can operator() their interaction with borders.
