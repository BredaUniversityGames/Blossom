...
public:
    ...
    /// Create a shader with vertex, tesselation and fragment programs
    Shader(FileIO::Directory directory, const std::string& vertexFilename, const std::string& tessControlFilename,
    ...
    bool LoadSource(const std::string& vertexShader, const std::string& tessControlShader,
                    const std::string& tessEvalShader, const std::string& geometryShader, const std::string& fragmentShader,
...
private:
    ...
    static std::string GetPath(FileIO::Directory, const std::string& computeFilename);
    ...
    /// Relative path to the tessellation control shader
    std::string m_tessControlFilename;

    /// Relative path to the tessellation evaluation shader
    std::string m_tessEvalFilename;

    /// Relative path to the compute shader
